...
<!-- 		</nav> -->
 ...
 <p id="timer" style="  text-align: center; font-size: 60px;margin-top: 0px;"></p>
		...
		<div id="content" class="p-4 p-md-5">
			...
			<form action="/student/user/submitAnswersC" method="post">
				<table class="table table-stripped">
<%-- 					<c:forEach items="${questions}" var="questionBank"> --%>
					<c:forEach var="counter" begin="0" end="${questions.size()-1}">
						<tr>
							<th>${counter+1}) ${questions.get(counter).questions}(${questionBank.get(counter).points}points)
							</th>
						</tr>

						<tr>
							<td><textarea rows="5" cols="100" name="answers"
									class="form-control" required></textarea></td>
							<td><input type="hidden" name="exam_code"
